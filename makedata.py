...
def initial_data():
    ...
    s2 = User.objects.create_user(
        "b", "b@cs.utah.edu", "b",
        first_name="Ben", last_name="Bitfiddle",
    )
...
""",
    ...
    Submission.objects.create(
        ...
        author=s2,
        grader=ta2,
        file=ContentFile("Github username for Ben Bitfiddle", name="b.txt"),
        score = 1.0,
    )
    Submission.objects.create(
        assignment=hw0,
    ...
    Submission.objects.create(
        ...
        author=s2,
        grader=ta2,
        file=ContentFile("HW1 for Ben Bitfiddle", name="b1.txt"),
    )
    Submission.objects.create(
        assignment=hw2,
        author=s1,
